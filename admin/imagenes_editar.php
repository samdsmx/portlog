...
$qry2 =("SELECT * FROM imagenes WHERE id_imagenes='$id_imagenes'");
...
if ( $r2 !== false && mysqli_num_rows($r2) > 0 ) 
{
	...
	$galeria = test_input($a['galeria']);
}
?>
<script type="text/javascript">
function goBack(){
	location.href="imagenes_actualizar.php";
}
</script>
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar imagenes</h1>
        </article>
        <article id="contenido-admin">
        	<form method="post" enctype="multipart/form-data" name="formulario" id="formulario" onReset="return goBack();">
               ...
               <h2 class="subtitulos">Orden:</h2>
                ...
                <input name="id_imagenes" value="<?php echo $id_imagenes;?>" type="hidden" class="campo" id="orden">
                 <input name="ima" value="<?php echo $ima;?>" type="hidden" class="campo" id="orden">     
                 <input name="galeria" value="<?php echo $galeria;?>" type="hidden" class="campo" id="orden">     
                ...
                <figure id="img"><img src="../img/imagenes/<?php echo $ima;?>" width="597"></figure>
...
if (file_exists("../img/imagenes/" . $ima))
	...
	mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE imagenes SET orden='$orden', titulo='$titulo', imagen='$nombrefile' WHERE id_imagenes='$id_imagenes'";
...
else
{
	...
	location.href="imagenes_editar.php?id_imagenes='.$id_imagenes.'";
	</SCRIPT>';	
}
}
else
	{
		mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE imagenes SET orden='$orden', titulo='$titulo' WHERE id_imagenes='$id_imagenes'";
			mysqli_query($con_admin, $qry44) or die(header('location:home.php'));
			echo"<script language='javascript'>window.location='imagenes_actualizar.php?galeria=".$galeria."'</script>";
	}	
