...
?>
    ...
    <section>
    	<article id="titulo-bienvenidos">
        	<h1 class="h1"><strong>SEO</strong></h1>
            <figure id="logo-cliente"><img src="../img/logo/portlog-logotipo.png" height="52px"></figure>
        </article>	
        ...
        <article id="bloque" onclick="location.href='seo_editar.php?seo=inicio'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-home.png" width="100%"></figure>
        	<h2>Inicio</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>
        
		<article id="bloque" onclick="location.href='seo_editar.php?seo=nosotros'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-nosotros.png" width="100%"></figure>
        	<h2>Nuestra empresa</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article> 
       
		<article id="bloque" onclick="location.href='seo_editar.php?seo=servicios'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-servicios.png" width="100%"></figure>
        	<h2>Servicios</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>
        
        <article id="bloque" onclick="location.href='seo_editar.php?seo=clientes'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-clientes.png" width="100%"></figure>
        	<h2>Clientes</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>
        
        <article id="bloque" onclick="location.href='seo_editar.php?seo=galeria'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-galeria.png" width="100%"></figure>
        	<h2>Galería</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>

         <article id="bloque" onclick="location.href='seo_editar.php?seo=contacto'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-contacto.png" width="100%"></figure>
        	<h2>Contacto</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>
        
         <article id="bloque" onclick="location.href='seo_editar.php?seo=aviso'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-home.png" width="100%"></figure>
