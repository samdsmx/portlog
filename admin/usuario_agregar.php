...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Agregar Usuario</h1>
        </article>
        <article id="contenido-admin">
        	<form method="post" enctype="multipart/form-data" name="formulario" id="formulario" onReset="return goBack();">
                ...
                <input name="password" type="text" class="campo" id="password">
...
{
	extract ($_REQUEST);
	echo"<script language='javascript'>window.location='alianzas.php'</script>";
}
...
if (isset($_POST['guardar']))
{
			...
			extract($_REQUEST);
			mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "INSERT INTO usuario2 (usuario, pass, fecha) VALUES ('$usuario', '$password', '$fecha')";
			mysqli_query($con_admin, $qry44) or die(header('location:home.php'));
			echo "<SCRIPT LANGUAJE='javascript'>window.location='usuario.php' </SCRIPT>";	
		}
