...
?>
    ...
    <section id="contenido2">
    	...
    	<article id="titulo">
        <?php if ($ids=='0') { ?>
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Actualizar Imágenes</h1>
        </article>
        ...
        <br>
         ...
         <article id="titulo">
        		<h2 class="h2"> Selecione una linea de producto:</h2> 
        	<ul class="submenus">
<?php 
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='imagen'";
...
?>	            	
                    <div id="bloque-actualizar">
                        <div id="bloque-imagen">
                            ...
                            <figure id="img"><img src="../img/op/<?php echo $imagen_prin;?>" width="200"></figure>
                        </div>
                        <div id="bloque-acciones">
                            <button class="actualizar" onclick="location.href='editar_tv1.php?ids=<?php echo $id_sec_3;?>&seccion=<?php echo $seccion;?>&sec=<?php echo $sec;?>'">Actualizar</button>
                        </div>
                     </div>      
...
<input type="file" name="imagen" id="imagen"><br>   
  ...
  <figure id="img"><img src="../img/op/<?php echo $imagen;?>" width="250"></figure>
<h4>Tamaño de la Imagen:375 x 165 </h4>
...
{
	extract ($_REQUEST);
	echo"<script language='javascript'>window.location='editar_tv1.php?sec=".$sec."&ids=0'</script>";
}
