...
?>
    ...
    <section id="contenido2">
      ...
      <input name="arc" type="hidden" value="<?php echo $archivo; ?>" />

  <h2 class="subtitulos">Título:</h2>
                <input name="titulo" type="text" class="campo" id="mensaje" value="<?php echo $titulo;?>">

<h2 class="subtitulos">Adjuntar imagen grande:</h2>
<input type="file" name="imagen" id="imagen"><br>

<h2 class="subtitulos">Adjuntar imagen chica:</h2>
<input type="file" name="archivo" id="imagen"><br>

<figure id="img"><img src="../img/op/<?php echo $imagen;?>" width="275" height="263"></figure>
<h4>Tamaño de la Imagen:1102 x 1054 px</h4>

<figure id="img"><img src="../img/op/<?php echo $archivo;?>" width="180" height="180"></figure>
<h4>Tamaño de la Imagen: 390 x 387 px</h4>
...
{	
	...
	$titulo_imagen = test_input($titulo_imagen);
	...
	if ($imagen != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', imagen='$imagen', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
			mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
		
			$destino = "../img/op/".$ima;
			if (copy($_FILES['imagen']['tmp_name'],$destino)) 
			{
				$status = "Archivo subido: <b>".$ima."</b>";
			} 
			else 
			{
	...
	if ($archivo != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', archivo='$archivo', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
			mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
		
			$destino = "../img/op/".$arc;
			if (copy($_FILES['archivo']['tmp_name'],$destino)) 
			{
				$status = "Archivo subido: <b>".$arc."</b>";
			} 
			else 
			{
				echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
	...
	{
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
	}
