...
?>
    ...
    <section>
        ...
        <article id="bloque" onclick="location.href='inicio.php'" style="cursor:pointer;">
		...
		<article id="bloque" onclick="location.href='nosotros.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-nosotros.png" width="100%"></figure>
        	<h2>Nuestra empresa</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article> 

        <article id="bloque" onclick="location.href='servicios.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-servicios.png" width="100%"></figure>
        	<h2>Servicios</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article> 
        
        <article id="bloque" onclick="location.href='clientes.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/configuracion/icono-clientes.png" width="100%"></figure>
        	<h2>Clientes</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article> 
        
        <article id="bloque" onclick="location.href='galeria.php'" style="cursor:pointer;">
