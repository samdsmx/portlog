...
<?php 
			  if( ($ids=='bloque5') || ($seccion=='bloque2') ){
				  $tam1='800';
				  $tam2='457';
				  $tam_width=$tam1/2;
				  $tam_height=$tam2/2;
			  }
			  else if ( ($seccion=='mision') || ($seccion=='vision') ){
				  $tam1='271';
				  $tam2='271';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
...
{	
	...
	if ($imagen != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', imagen='$imagen', descripcion='$descripcion1', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
	...
	{
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo', descripcion='$descripcion1', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
	}
