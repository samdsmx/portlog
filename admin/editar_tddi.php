...
<h2 class="subtitulos">Descripción 2:</h2>
<textarea class="mceEditor" name="texto" rows=""><?php echo $texto;?></textarea>

<h2 class="subtitulos">Adjuntar imagen:</h2>
<input type="file" name="imagen" id="imagen"><br>
<?php 
			  if( ($ids=='24') || ($seccion=='bloque1') ){
				  $tam1='688';
				  $tam2='639';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
			  ...
			  else if ( ($seccion=='cert') || ($seccion=='cert2') ){
				  $tam1='177';
				  $tam2='169';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
			  ...
			  else if ( ($seccion=='empaques') || ($seccion=='etiquetas') || ($seccion=='forma') || ($seccion=='cintas') ){
				  $tam1='635';
				  $tam2='735';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
...
{	
	...
	if ($imagen != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', imagen='$imagen', descripcion='$descripcion1', texto='$texto', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
	...
	{
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo', descripcion='$descripcion1', texto='$texto', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
	}
