...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar Favicon</h1>
        </article>
...
<figure id="img"><img src="../img/favicon/favicon.ico" width="35" height="35"></figure>
...
if (isset($_POST['Enviar']) ) 
{
	...
	if ( (strpos($tipo_Imagen, "jpeg") || strpos($tipo_Imagen, "ico") || strpos($tipo_Imagen, "png") || strpos($tipo_Imagen, "gif")))
	{ 
