...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Servicios</h1>
        </article>
        ...
        <article id="contenido-admin">
            ...
            <div id="bton" class="modificar"><p><a href="servicios_actualizar.php">Modificar</a></p></div>
        </article>

<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='servicios'";
