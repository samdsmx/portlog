...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Actualizar Título de la Página</h1>
        </article>
...
if(isset($_POST['enviar']))
{
	...
	mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo' WHERE id_op='$ids'");
