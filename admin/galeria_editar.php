...
$qry2 =("SELECT * FROM galeria WHERE id_galeria='$id_galeria'");
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar galeria</h1>
        </article>
        <article id="contenido-admin">
        	<form method="post" enctype="multipart/form-data" name="formulario" id="formulario" onReset="return goBack();">
               ...
               <h2 class="subtitulos">Orden:</h2>
                ...
                <input name="id_galeria" value="<?php echo $id_galeria;?>" type="hidden" class="campo" id="orden">
                ...
                <figure id="img"><img src="../img/galeria/<?php echo $ima;?>" width="597"></figure>
...
if (file_exists("../img/galeria/" . $ima))
			{
				unlink($rutaNueva.$ima);
			}	
	copy($_FILES['imagen']['tmp_name'], $rutaNueva.$nombrefile);
	mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE galeria SET orden='$orden', titulo='$titulo', imagen='$nombrefile' WHERE id_galeria='$id_galeria'";
...
else
{
	...
	location.href="galeria_editar.php?id_galeria='.$id_galeria.'";
	</SCRIPT>';	
}
}
else
	{
		mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE galeria SET orden='$orden', titulo='$titulo' WHERE id_galeria='$id_galeria'";
			mysqli_query($con_admin, $qry44) or die(header('location:home.php'));
			echo"<script language='javascript'>window.location='galeria_actualizar.php'</script>";
	}	
