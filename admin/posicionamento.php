...
?>
    ...
    <section>
    	...
    	<article id="titulo-bienvenidos">
        	<h1 class="h1"><strong>Posicionamiento</strong> a tu cuenta</h1>
        </article>	
		...
		<article id="bloque" onclick="location.href='seo.php?sec=home.php'" style="cursor:pointer;">
        ...
        <article id="bloque" onclick="location.href='sem.php?sec=home.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/index/icono-posicionamiento.png" width="100%"></figure>
        	<h2>SEM</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
        </article>
        
       <!-- <article id="bloque" onclick="location.href='redes.php?sec=home.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/index/icono-posicionamiento.png" width="100%"></figure>
