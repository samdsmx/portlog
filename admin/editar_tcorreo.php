...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Actualizar Formulario</h1>
        </article>
...
<h2 class="subtitulos">Correos:</h2>
<textarea  name="descripcion1" class="campo" ><?php echo $descripcion1;?></textarea>


  <h2 class="subtitulos">Título del  Gracias:</h2>
                <input name="subtitulo" type="text" class="campo" id="subtitulo" value="<?php echo $subtitulo;?>">
                
<h2 class="subtitulos">Modificar el Gracias:</h2>
<textarea  name="texto" class="mceEditor" ><?php echo $texto;?></textarea>
...
if(isset($_POST['Enviar']))
{
	...
	mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET descripcion='$descripcion1',subtitulo='$subtitulo',texto='$texto' WHERE id_op='$ids'");
