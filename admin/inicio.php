...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Inicio</h1>
        </article>
        ...
        <article id="contenido-admin">
        	<h2 class="subtitulos">Banner</h2>
            <div id="bton" class="modificar"><p><a href="banner_actualizar.php">Modificar</a></p></div>
        </article>

<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='bloque1'";
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='bloque2'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='bloque3'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='bloque4'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_tsdi.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='bloque5'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
