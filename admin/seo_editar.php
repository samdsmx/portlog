...
$qry2 =("SELECT * FROM metas WHERE seccion='$seo'");
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">SEO <strong><?php echo $meta_tit; ?></strong></h1>
        </article>
        ...
        <article id="contenido-admin">
            ...
            <input name="id_metas" type="hidden" value="<?php echo $id_metas; ?>">
            
        		<h2 class="subtitulos">Meta título:</h2>
            	<textarea name="meta_titulo" id="meta_titulo" class="campo"><?php echo $meta_tit;?></textarea>
                <h2 class="subtitulos">Meta descripción:</h2>
            	<textarea name="meta_descripcion" id="meta_descripcion" class="campo"><?php echo $meta_desc;?></textarea>
                <h2 class="subtitulos">Meta palabra clave:</h2>
            	<textarea name="meta_keys" id="meta_keys" class="campo"><?php echo $meta_keys;?></textarea>
                <input name="seccion" type="hidden" id="seccion" value="<?php echo $sec;?>" />
...
if(isset($_POST['enviar']))
{
	extract ($_REQUEST);
	mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE metas SET meta_tit='$meta_titulo', meta_desc='$meta_descripcion', meta_keys='$meta_keys' WHERE id_metas='$id_metas'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));		
	echo"<script language='javascript'>window.location='seo.php'</script>";
}
?>
