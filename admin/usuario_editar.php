...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar Usuario</h1>
        </article>
        <article id="contenido-admin">
        	<form method="post" enctype="multipart/form-data" name="formulario" id="formulario" onReset="return goBack();">
               ...
               <h2 class="subtitulos">usuario:</h2>
                <input name="usuario" value="<?php echo $usuario;?>" type="text" class="campo" id="orden">

                 <h2 class="subtitulos">Teléfono:</h2>
                <input name="id_usuario" value="<?php echo $pass;?>" type="text" class="campo" id="orden">
...
if (isset($_POST['guardar']) ) 
{
		extract($_REQUEST);
		mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE usuario2 SET usuario='$usuario', pass='$pass' WHERE id_usuario2='$id_usuario2'";
