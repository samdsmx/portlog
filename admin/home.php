...
<script type="text/javascript">
function goBack(){
	location.href="posicionamiento.php";
}
</script>
<!-- InstanceEndEditable -->
...
?>
    ...
    <section>
    	<article id="titulo-bienvenidos">
        	<h1 class="h1"><strong>Bienvenido</strong> a tu cuenta</h1>
            <figure id="logo-cliente"><img src="../img/logo/portlog-logotipo.png" height="52px"></figure>
        </article>	
		<article id="bloque"  onclick="location.href='cms.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/index/icono-administrador-contenido.png" width="100%"></figure>
        	<h2>Administrador de contenidos</h2>
        	<div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
         </article>
        
		<article id="bloque" onclick="location.href='posicionamento.php?sec=home.php'" style="cursor:pointer;">
    		<figure><img src="imagenes/index/icono-posicionamiento.png" width="100%"></figure>
        	<h2>Posicionamiento</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
        </article>
        
		<article id="bloque">
    		<figure><img src="imagenes/index/icono-configuracion-de-la-cuenta.png" width="100%"></figure>
        	<h2>Configuración de<br>la cuenta</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article> 
        
		<article id="bloque">
    		<figure><img src="imagenes/index/icono-administrador-de-usuario.png" width="100%"></figure>
        	<h2>Administrador de<br> usuarios</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>
        
		<article id="bloque" onclick="location.href='contacto.php?seo=home'" style="cursor:pointer;">
    		<figure><img src="imagenes/index/icono-contacto.png" width="100%"></figure>
        	<h2>Contacto</h2>
            <div id="btn"><img src="imagenes/index/btn.jpg" width="87" height="15"></div>
    	</article>

		<article id="bloque">
    		<figure><img src="imagenes/index/icono-redes-sociales.png" width="100%"></figure>
