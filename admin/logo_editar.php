...
$qry2 =("SELECT * FROM op4 WHERE seccion='logotipo'");
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar Logo</h1>
        </article>
...
<figure id="logo-cliente"><img src="../img/logo/portlog-logotipo.png" width="280"></figure>
<h4>Tamaño de imagen: 474 x 209 px</h4>
...
if (isset($_POST['Enviar']) ) 
{
	...
	$nombre = "portlog-logotipo.png";
	$rutaNueva="../img/logo/".$nombre;
	
if ($nombrefile != "") 
	{	
	if ( (strpos($tipo_Imagen, "jpeg") || strpos($tipo_Imagen, "png") || strpos($tipo_Imagen, "gif")))
	{ 
		copy($_FILES['imagen']['tmp_name'], $rutaNueva);
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(mysqli_error());	
		echo"<script language='javascript'>window.location='".$sec.".php'</script>";
	}
	else
	{
