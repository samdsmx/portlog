                ...
                <div class="navegacion">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="interiores/nuestras-empresa.php">Nuestra Empresa</a></li>
                            <li><a href="interiores/servicios.php">Servicios</a></li>
                            <li><a href="interiores/clientes.php">Clientes</a></li>
                            <li><a href="interiores/galeria-proyectos.php">Galería Proyectos </a></li>
...
<footer>
    ...
    <div class="wrapper">
        ...
        <div class="pie1">
        	<p><?php echo $desca1; ?></p>
    		<a href="interiores/aviso.php"><?php echo $tita1; ?></a>
        </div>
