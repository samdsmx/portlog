...
<h1 class="titulos"><?php echo $titb1; ?></h1>
    ...
    <div class="cont_der">
        ...
        <form  name="form1" method="post" onsubmit="return validacion_registro();" >
            ...
            <div class="btn_cont"><input name="telefono" placeholder="*Phone:" type="text" class="fomrulario3" id="telefono"></div>
            
        	<div class="btn_cont2"><input name="email" placeholder="*Email:" type="text" class="fomrulario3" id="email"></div>
            
            <div class="btn_cont3"><textarea name="mensaje" id="mensaje" placeholder="Comments:" class="fomrulario4" cols="" rows=""></textarea></div>
...
$para      = $descf1; ;
$titulo    = 'Portlog';
$cabeceras = 'From: Portlog | Contacto-Ingles <inmuebles@telesites.com.mx>' . "\r\n" .
             'Cc: "'.$email.'"' . "\r\n" .
