...
<div class="wrapper"><h1 class="titulos"><?php echo $titb1; ?></h1></div>
...
$cont=0;          
mysqli_select_db($con_admin, $database_con_admin);
$qry2 = "SELECT * FROM servicios ORDER BY orden ASC ";
$r2 = mysqli_query($con_admin, $qry2) or die(header('location:home.php'));
if ( $r2 !== false && mysqli_num_rows($r2) > 0 ) 
{
...
?>  
    ...
    <div class="wrapper">
        ...
        <figure><img src="../img/servicios/<?php echo $img_servicios; ?>" title="<?php echo $titulo; ?>" alt="<?php echo $titulo,'-',$img_servicios; ?>"></figure>
        <article>
