...
<!--------------------------------FAVICON-------------------------------->
<link type="image/x-icon" href="../admin/imagenes/plantilla/favicon.ico" rel="icon" /> 
<!--------------------------------FAVICON-------------------------------->
<!--------------------------------ESTILOS-------------------------------->
<link href="../admin/css/normalize.css" rel="stylesheet" type="text/css" />
<link href="../admin/css/estilos.css" rel="stylesheet" type="text/css" />
<link href="../admin/css/estilos_responsive.css" rel="stylesheet" type="text/css" />
<link href="../admin/paginacion/paginacion.css" rel="stylesheet" type="text/css" />
<!--------------------------------ESTILOS-------------------------------->
<script src="../admin/menu/js/jquery-latest.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="../admin/menu/css/icomoon.css"/>
...
<header id="encabezado">
	<article id="back-negro">
    	<div id="centro">
      		<div id="boton-sesion"><a href="../admin/logout.php">Cerrar Sesión</a></div>
        </div>    
    </article>
    
    <article id="datos-encabezado">
    	<div id="centro2">
    		<figure id="logo"><a href="../admin/cms.php"><img src="../admin/imagenes/plantilla/admin-central-logotipo.png" width="100%" border="0"></a></figure>
        	<div id="telefono">
...
<div id="responsive-admin-menu">
	...
	<!--Menu-->
	<div id="menu">
    	<a href="../admin/home.php" title="Inicio"><i class="icon-home"></i><span>Inicio</span></a>
