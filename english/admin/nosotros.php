...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Nuestra empresa</h1>
        </article>
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='nosotros'";
...
?>	        
        <article id="contenido-admin3">
            ...
            <div id="bton" class="modificar"><p><a href="editar_tsd.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='mision'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='vision'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>
 ...
 <article id="contenido-admin3">
        	<h2 class="subtitulos">Imagenes Nuestra empresa</h2>
            <div id="bton" class="modificar"><p><a href="editar_tv1.php?ids=0&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
