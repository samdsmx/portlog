...
if ( $r2 !== false && mysqli_num_rows($r2) > 0 ) 
{
	...
	$descripcion1 = stripslashes($a['descripcion']);
	$texto = stripslashes($a['texto']);
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Actualizar</h1>
        </article>
      ...
      <input name="ima" type="hidden" value="<?php echo $imagen; ?>" />

  <h2 class="subtitulos">Título:</h2>
                <input name="titulo" type="text" class="campo" id="mensaje" value="<?php echo $titulo;?>">
                
                
                <h2 class="subtitulos">Subtítulo:</h2>
                <input name="subtitulo" type="text" class="campo" id="mensaje" value="<?php echo $subtitulo;?>">

<h2 class="subtitulos">Descripción:</h2>
<textarea class="mceEditor" name="descripcion1" rows=""><?php echo $descripcion1;?></textarea>
...
<?php 
			  if(($seccion=='bloque4') ){
				...
				else if ($seccion=='bloque5') {
				  $tam1='197';
				  $tam2='280';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
			  }
			  else if ($seccion=='bloque6') {
				  $tam1='227';
				  $tam2='275';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
...
<figure id="img"><img src="../img/op/<?php echo $imagen;?>" width="<?php echo $tam_width; ?>" height="<?php echo $tam_height; ?>"></figure>
<h4>Tamaño de la Imagen: <?php echo $tam1; ?> x <?php echo $tam2; ?></h4>


<h2 class="subtitulos">Título Imagen:</h2>
<textarea class="campo" name="tit_imagen"><?php echo $tit_imagen; ?></textarea>
...
{	
	extract($_REQUEST);
	$tit_imagen = test_input($tit_imagen);
	...
	if ($imagen != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', subtitulo='$subtitulo', descripcion='$descripcion1', imagen='$imagen', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
	...
	{
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo', subtitulo='$subtitulo', descripcion='$descripcion1', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
	}
