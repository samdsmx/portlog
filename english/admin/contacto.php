...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Contacto</h1>
        </article>
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='contacto'";
...
?>	        
        <article id="contenido-admin3">
            ...
            <div id="bton" class="modificar"><p><a href="editar_tsi.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<article id="contenido-admin3">
        	<h2 class="subtitulos">Imagenes Contacto</h2>
            <div id="bton" class="modificar"><p><a href="editar_tv2.php?ids=0&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>

<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='direccion'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_td2.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='telefono'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='email'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='contamos'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_tdi.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='formulario'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_tcorreo.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Pie de página</h1>
 

<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='aviso'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_td.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='leyenda'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='empresa'";
$r = mysqli_query($con_admin, $qry) or die(header('location:home.php'));
if ( $r !== false && mysqli_num_rows($r) > 0 ) 
{
	while ($a = mysqli_fetch_assoc($r))
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?></h2>
            <div id="bton" class="modificar"><p><a href="editar_ti.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
