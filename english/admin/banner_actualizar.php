...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-banner.jpg" width="35" height="24">Banner</h1>
        </article>
        ...
        <article id="contenido-admin">
            ...
            <button class="agregar" onclick="location.href='banner_agregar.php'">Agregar</button>
        </article>
        ...
        <article id="contenido-admin">
            ...
            <p class="texto">4000 x 1216 px</p>
        </article>
...
if ( $r2 !== false && mysqli_num_rows($r2) > 0 ) 
{
	...
	{
		$id_banner = test_input($a2['id_banner']);
		$img_banner = test_input($a2['imagen']);
		$orden_banner = test_input($a2['orden']);
		$titulo = test_input($a2['titulo']);
?>              
                
                    <div id="bloque-actualizar">
                        <div id="bloque-imagen">
                            <p class="texto"><?php echo $orden_banner;?>.- <?php echo $titulo; ?></p>
                            <figure id="img"><img src="../img/banner/<?php echo $img_banner;?>" width="378" height="144"></figure>
                        </div>
                        <div id="bloque-acciones">
                            <button class="actualizar" onclick="location.href='banner_editar.php?id_banner=<?php echo $id_banner;?>'">Actualizar</button>
							
                            <button class="eliminar" onclick="if (confirm('¿Desea eliminar el Banner?')==true){window.location.href='banner_eliminar.php?id_banner=<?php echo $id_banner; ?>'}">Eliminar</button>
