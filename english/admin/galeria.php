...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Galería</h1>
        </article>
...
<article id="contenido-admin3">
        	<h2 class="subtitulos">Galería de eventos</h2>
            <div id="bton" class="modificar"><p><a href="galeria_actualizar.php">Modificar</a></p></div>
        </article>

<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='galeria'";
...
?>	        
        <article id="contenido-admin3">
        	<h2 class="subtitulos"><?php echo $tit_sec_2;?> Título</h2>
            <div id="bton" class="modificar"><p><a href="editar_t.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
