...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">SEM</h1>
        </article>
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry = "SELECT * FROM op4 where seccion='sem1'";
...
?>	        
        <article id="contenido-admin3">
            ...
            <div id="bton" class="modificar"><p><a href="editar_d2.php?ids=<?php echo $id_sec_2;?>&sec=<?php echo $sec;?>">Modificar</a></p></div>
        </article>
        <br>
<?php
	}
