...
<h2 class="subtitulos">URL:</h2>
<textarea class="campo" name="descripcion1" rows=""><?php echo $descripcion1;?></textarea>

<h2 class="subtitulos">Adjuntar imagen:</h2>
<input type="file" name="imagen" id="imagen"><br>
<?php 
			  if( ($seccion=='bloque1') || ($seccion=='bloque2') || ($seccion=='bloque3') ){
				  $tam1='218';
				  $tam2='214';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
			  }
			   else if (($seccion=='desayunados') || ($seccion=='comida') || ($seccion=='merienda') ){
				  $tam1='805';
				  $tam2='505';
				  $tam_width=$tam1;
				  $tam_height=$tam2;
...
{	
	...
	$descripcion1 = test_input($descripcion1);
