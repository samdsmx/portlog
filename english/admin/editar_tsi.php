...
<figure id="img"><img src="../img/op/<?php echo $ima;?>" width="<?php echo $tam_width; ?>" height="<?php echo $tam_height; ?>"></figure>
...
{	
	...
	if ($imagen != "") 
	{
		...
		{
			mysqli_select_db($con_admin, $database_con_admin);
			$qry =("UPDATE op4 SET titulo='$titulo', subtitulo='$subtitulo', imagen='$imagen', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
	...
	{
		mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo', subtitulo='$subtitulo', titulo_imagen='$tit_imagen', desc_imagen='$desc_imagen' WHERE id_op='$ids'");
		mysqli_query($con_admin, $qry) or die(header('location:home.php'));	
	}
