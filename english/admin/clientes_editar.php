...
$qry2 =("SELECT * FROM clientes WHERE id_clientes='$id_clientes'");
...
<script type="text/javascript">
function goBack(){
	location.href="clientes_actualizar.php";
}
</script>
...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Editar clientes</h1>
        </article>
        <article id="contenido-admin">
        	<form method="post" enctype="multipart/form-data" name="formulario" id="formulario" onReset="return goBack();">
               ...
               <h2 class="subtitulos">Orden:</h2>
                ...
                <input name="id_clientes" value="<?php echo $id_clientes;?>" type="hidden" class="campo" id="orden">
                ...
                <figure id="img"><img src="../img/clientes/<?php echo $ima;?>" width="597"></figure>
...
if (file_exists("../img/clientes/" . $ima))
			{
				unlink($rutaNueva.$ima);
			}	
	copy($_FILES['imagen']['tmp_name'], $rutaNueva.$nombrefile);
	mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE clientes SET orden='$orden', titulo='$titulo', imagen='$nombrefile' WHERE id_clientes='$id_clientes'";
...
else
{
	...
	location.href="clientes_editar.php?id_clientes='.$id_clientes.'";
	</SCRIPT>';	
}
}
else
	{
		mysqli_select_db($con_admin, $database_con_admin);
			$qry44 = "UPDATE clientes SET orden='$orden', titulo='$titulo' WHERE id_clientes='$id_clientes'";
			mysqli_query($con_admin, $qry44) or die(header('location:home.php'));
			echo"<script language='javascript'>window.location='clientes_actualizar.php'</script>";
	}	
