...
?>
    ...
    <section id="contenido2">
    	<article id="titulo">
        	<h1 class="h2"><img src="imagenes/interiores/icono-casa.jpg" width="35" height="24">Actualizar URL</h1>
        </article>
...
if(isset($_POST['Enviar']))
{
	...
	mysqli_select_db($con_admin, $database_con_admin);
		$qry =("UPDATE op4 SET titulo='$titulo',descripcion='$descripcion1' WHERE id_op='$ids'");
