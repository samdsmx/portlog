...
<meta name="keywords" content="portlog, portlog clientes, logista, proyectos industriales, transportacion martima, transportacion terrestre, transportacion aerea, PORTLOG INTERNATIONAL, importaciones, exportaciones, empresas de logistica, logistica internacional" />
...
<title>PORTLOG INTERNATIONAL | Clientes</title>
...
<?php              
mysqli_select_db($con_admin, $database_con_admin);
$qry2 = "SELECT * FROM clientes ORDER BY orden ASC";
$r2 = mysqli_query($con_admin, $qry2) or die(header('location:home.php'));
if ( $r2 !== false && mysqli_num_rows($r2) > 0 ) 
{
...
?>      
    <div class="cliente col-xl-3 col-mc-4 col-ch-12">
    	<figure><img src="../img/clientes/<?php echo $img_clientes; ?>" title="<?php echo $titulo; ?>" alt="<?php echo $tit_imgl1,'-',$titulo; ?>" ></figure>
